...
Der \lstinline{Animator} steuert die Bewegungen des Spielercharakters und bildet somit den Kern der Anwendung. Er beinhaltet Repräsentationen der vier Gliedmaßen des Spielers in \lstinline{limbs} und Splines zur Bewegung dieser in \lstinline{spline_prototypes}.
Der genaue Ablauf des Animationsprozesses wird im Abschnitt \ref{animator_section} ausführlich erklärt.


\subsection{Rendering und Shader}
