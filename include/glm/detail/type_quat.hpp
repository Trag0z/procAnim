...
#pragma warning(pop)
    ...
    template <qualifier P> GLM_FUNC_DECL GLM_CONSTEXPR qua(qua<T, P> const& q);
    ...
    template <typename U>
    GLM_FUNC_DECL qua<T, Q>& operator*=(qua<U, Q> const& q);
    template <typename U> GLM_FUNC_DECL qua<T, Q>& operator*=(U s);
    template <typename U> GLM_FUNC_DECL qua<T, Q>& operator/=(U s);
};
...
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR bool operator==(qua<T, Q> const& q1,
                                            qua<T, Q> const& q2);
